...
function Lectures() {
  return (
    <div>
        <>
        <Component>
        <TextHead>Past Lectures</TextHead>
            <Container>
                
                <Boxone>
                    <Text><ArrowRightIcon/>ES6 version, JS currying, ES6 Classes, JS Static Methods,</Text>
                </Boxone>
                <Boxtwo>
                <Text><ArrowRightIcon/>Alum session</Text>
                </Boxtwo>
                <Boxthree>
          <Icon  style={{color:'#0097e6',fontSize:'35',justifyContent:'center'}}/>
          <TextBtn>Past Lectures</TextBtn>
        </Boxthree>
            </Container>
        </Component>
        <Line/>
